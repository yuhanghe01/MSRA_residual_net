#this file is implemented to msra Residual Learning 34 layers network for Caffe
# author: Yuhang He
# email: heyuhang@dress-plus.com
# date: Jan. 2, 2016

f = file("msra_residualnet_34layers.prototxt", 'w+')
name = "name: \"msra_residual_learning_34layers\"\n"
data_layer = "\nlayer{\n\
  name: \"data\"\n\
  type: \"Data\"\n\
  top: \"data\"\n\
...
f.writelines("#prototxt for msra residual learning 34 layers for caffe framework\n\
#author: Yuhang He\n\
#date: Jan. 2, 2016\n\
#email: heyuhang@dress-plus.com\n ")
